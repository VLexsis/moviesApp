...
import './movies-card.css' // Импортируем CSS-файл
            ...
            <Online>
                <div className="movies-container">
                    ...
                    <Input
                        ...
                        className="movies-container__search" // Класс для формы поиска
                    />
                    {(() => {
                        if (loading) {
                            return <Spinner />
                        ...
                        if (!loading && movies.length > 0) {
                            return (
                                <div className="movies-container__movies">
                                    {' '}
                                    ...
                                    <Row gutter={[16, 16]}>
                                        {movies.map((movie) => (
                                            <Col key={movie.id} xs={24} sm={12} md={12} lg={12}>
                                                <Card
                                                    hoverable
                                                    className="movie-card" // Используем класс из CSS
